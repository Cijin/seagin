...
That would be silly, there is something JavaScript is really good at. User interactions. Everything else is a No! For interactions I still and will always use JavaScript, it's amazing at it. I have no beef with JavaScript, I'd just like to use it sparingly, for scripting on pages.
